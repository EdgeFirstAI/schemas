...
propvec &get_type_props<::sensor_msgs::msg::PointCloud2>() {
  ...
  props.push_back(entity_properties_t(1, 3, false, bb_unset, extensibility::ext_final, false));  //::fields
  entity_properties_t::append_struct_contents(props, get_type_props<::sensor_msgs::msg::PointField>());  //internal contents of ::fields
