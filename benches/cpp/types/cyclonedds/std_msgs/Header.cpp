...
propvec &get_type_props<::std_msgs::msg::Header>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, get_bit_bound<::builtin_interfaces::msg::Time>(), extensibility::ext_final, false));  //::stamp
  entity_properties_t::append_struct_contents(props, get_type_props<::builtin_interfaces::msg::Time>());  //internal contents of ::stamp
