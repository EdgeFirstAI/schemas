...
public:
  ...
  const ::builtin_interfaces::msg::Time& stamp() const { return this->stamp_; }
  ::builtin_interfaces::msg::Time& stamp() { return this->stamp_; }
  void stamp(const ::builtin_interfaces::msg::Time& _val_) { this->stamp_ = _val_; }
  void stamp(::builtin_interfaces::msg::Time&& _val_) { this->stamp_ = _val_; }
...
template<> constexpr unsigned int TopicTraits<::std_msgs::msg::Header>::type_map_blob_sz() { return 508; }
template<> constexpr unsigned int TopicTraits<::std_msgs::msg::Header>::type_info_blob_sz() { return 148; }
