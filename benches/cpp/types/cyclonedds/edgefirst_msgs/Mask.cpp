...
propvec &get_type_props<::edgefirst_msgs::msg::Mask>() {
  ...
  props.push_back(entity_properties_t(1, 2, false, get_bit_bound<uint32_t>(), extensibility::ext_final, false));  //::length
  props.push_back(entity_properties_t(1, 3, false, bb_unset, extensibility::ext_final, false));  //::encoding
  props.push_back(entity_properties_t(1, 4, false, bb_unset, extensibility::ext_final, false));  //::mask
  props.push_back(entity_properties_t(1, 5, false, get_bit_bound<bool>(), extensibility::ext_final, false));  //::boxed
