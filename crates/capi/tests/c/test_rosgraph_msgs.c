 ...
 * builtin_interfaces_time_encode/builtin_interfaces_time_decode. This file is a placeholder.
 */
...
Test(rosgraph_msgs, clock_via_time_encode_decode) {
    ...
    int ret = builtin_interfaces_time_encode(buf, sizeof(buf), &written, 1000000, 123456789);
    cr_assert_eq(ret, 0);
